...
export default async function signUp(
  ...
  try {
    ...
    console.log("email", email, "password", password, "userType", userType, "companyAddress", companyAddress, "companyEmail", companyEmail, "companyPhone", companyPhone, "isCompanyEmailAvailable", isCompanyEmailAvailable, "photoURL", photoURL)
    // Set basic user data
