...
function FileForm({ processedModels }) {
    ...
    const fetchCompanyInfo = async () => {
      try {
        ...
        const companyData = {
          ...
          email: userDoc.data().companyEmail,
          phone: userDoc.data().companyPhone,
          address: userDoc.data().companyAddress,
  ...
  const onSubmit = async (e) => {
    ...
    const data = {
      ...
      company: [
        {
          name: e.nombreCompania,
          email: e.emailCompania,
          phone: e.telefonoCompania,
  ...
  return (
    <div>
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div>
          <fieldset>
            <label className="block mb-2 text-3xl font-semibold text-white title">
              Tabla de Productos
            </label>
