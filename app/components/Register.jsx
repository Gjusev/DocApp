          ...
          {userType === "normal" && (
            <div className="flex items-center space-x-2">
              <input
                ...
                onChange={() =>
                  setIsCompanyEmailAvailable(!isCompanyEmailAvailable)
                }
                className="w-6 h-6 p-1 border border-gray-600 rounded"
              />
              <label htmlFor="availableCheckbox" className="text-white">
            ...
            <>
              <div className="flex items-center space-x-2">
                <input
                  ...
                  className="w-6 h-6 p-1 border border-gray-600 rounded"
                />
                <label htmlFor="sameCompanyCheckbox" className="text-white">
